...
export default function Contact() {
  return (
    <section className="container section contact-page">
      <p className="eyebrow">
        <span className="status-dot" /> ST / CONTACTO
      </p>
      <h1>
        Contanos
        <br />
        tu idea<span className="spark">.</span>
      </h1>
      ...
      <div className="contact-options">
        <article>
          ...
          {site.email ? (
            ...
            <p>El correo de contacto estará disponible próximamente.</p>
          )}
        </article>
        <article>
          ...
          {site.whatsapp ? (
            ...
            <p>El canal de WhatsApp estará disponible próximamente.</p>
          )}
        </article>
      </div>
      {!site.email && !site.whatsapp && (
        <p className="contact-notice">
          Estamos preparando nuestros canales de contacto. Mientras tanto, podés
